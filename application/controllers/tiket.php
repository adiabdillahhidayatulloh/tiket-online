...
class Tiket extends CI_Controller{
    ...
    function index () {
        $data['tiket'] = $this->m_data->tampil_data()->result();
    ...
    function tambah_aksi() {
        ...
        if ($pesawat == 'Garuda' && $kelas == 'Eksekutif') {
            ...
            $harga = 400000;
        }elseif ($pesawat == 'Lion' && $kelas == 'Eksekutif') {
            $harga = 1000000;
        }elseif ($pesawat == 'Lion' && $kelas == 'Bisnis') {
            $harga = 700000;
        }elseif ($pesawat == 'Lion' && $kelas == 'Ekonomi') {
            $harga = 300000;
        }
    ...
    function edit($id) {
        $where = array('id' => $id);
        $data['tiket'] = $this->m_data->edit_data($where, 'tiket')->result();
    ...
    function update(){
        ...
        $this->m_data->update_data($where, $data, 'tiket');
        redirect('tiket');
    }
	...
	function hapus($id){
		$where = array('id' => $id);
		$this->m_data->hapus_data($where,'tiket');
		redirect('tiket');
	}
